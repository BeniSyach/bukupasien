...
{
  $ambil = $db1->query("SELECT * FROM huruf_h WHERE nama='$_POST[nama_lengkap]' or nomor='$_POST[email]' ");
    $yangcocok = $ambil->num_rows;
        ...
        {
         $ambil= $db1->query("INSERT INTO huruf_h (nama,nomor,huruf) VALUES ('$_POST[nama_lengkap]','$_POST[email]','$_POST[password]')");
