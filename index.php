...
<!--  H1 can have 2 designs: "logo" and "logo cursive"           -->
        ...
        <div class="content">
            ...
            <div class="subscribe">
                <h5 class="info-text">
                    Silahkan login dengan Email dan Kata Sandi yang benar
                </h5>
                <div class="row">
                    <div class="info-text">
                        <form action="login.php" method="post" class="form-inline" enctype="multipart/form-data">
                          ...
                          <br><br>
                           <button name="login" class="btn btn-danger btn-fill">Masuk</button>
                        </form>
                    </div>
                </div>
            </div>
